...
SET
  ...
  seo_keywords = ARRAY['vintage sweatshirt', 'retro sweatshirt', 'vintage activewear'],
  default_tags = ARRAY['sweatshirt', 'vintage', 'streetwear', 'casual', 'activewear'],
...
SET
  ...
  default_tags = ARRAY['vintage', 'casual', 'shirt', 'tee', 'retro'],
...
SET
  ...
  default_tags = ARRAY['jacket', 'vintage', 'outerwear', 'coat', 'layering'],
...
SET
  ...
  default_tags = ARRAY['pants', 'vintage', 'bottoms', 'trousers', 'classic'],
...
SET
  ...
  default_tags = ARRAY['shorts', 'vintage', 'summer', 'casual', 'retro'],
...
SET
  ...
  seo_keywords = ARRAY['vintage dress', 'retro dress', 'womens vintage'],
  default_tags = ARRAY['vintage', 'womens', 'fashion', 'elegant', 'clothing'],
...
SET
  ...
  seo_keywords = ARRAY['vintage skirt', 'retro skirt', 'womens vintage'],
  default_tags = ARRAY['vintage', 'womens', 'fashion', 'classic', 'clothing'],
...
SET
  ...
  seo_keywords = ARRAY['vintage hat', 'retro headwear', 'vintage accessories'],
  default_tags = ARRAY['vintage', 'accessories', 'headwear', 'retro', 'classic'],
...
SET
  ...
  default_tags = ARRAY['womens', 'vintage', 'fashion', 'feminine', 'style'],
...
SET
  ...
  default_tags = ARRAY['mystery box', 'vintage', 'bundle', 'collection', 'reseller'],
