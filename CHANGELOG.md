...
### Navigation
- **One step at a time on a phone.** On a screen 640px or narrower the four workflow steps no longer sit on one long page: a stepper (Upload · Group · Describe · Export) shows which step you are on and only that step is on screen. Tap any step you have reached to move forward or back, or use the Back and "Continue to …" buttons at the bottom of each one; steps you have not unlocked yet are greyed out and say what unlocks them. Uploading photos carries you to Group automatically; nothing else moves you on its own. Reopening a batch picks up at the furthest step it has work for. Nothing is unmounted behind the scenes, so an upload in flight, your photo selection and Step 3's auto-save all keep running while you move between steps. Tablet and desktop are unchanged.
