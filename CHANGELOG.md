...
- **Step 3 progress bar simplified.** It shows only "Product Group N of M" over the green fill; the image-count and category chips are gone (the photos are right below, the category is in the form). The checkbox at its right is now labelled "Select for bulk apply": tick listings as you page through, then Apply preset or Paste crop acts on all of them at once.
