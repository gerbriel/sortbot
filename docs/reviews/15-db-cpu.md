...
**Debounce 2 s → 5 s.** AGENTS.md §11's rail is a floor, not a target. Both things it protects were re-read in code before relying on them:
...
AGENTS.md, README and CHANGELOG were not touched. Nothing was committed.
