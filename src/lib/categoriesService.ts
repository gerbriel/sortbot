...
export async function initializeDefaultCategories(): Promise<void> {
  ...
  const defaultCategories = [
    { name: 'sweatshirts', display_name: 'Sweatshirts', emoji: '🧥', color: '#e4e4e7', sort_order: 1, templateKey: 'Sweatshirts' },
    { name: 'outerwear', display_name: 'Outerwear', emoji: '🧥', color: '#9fb0aa', sort_order: 2, templateKey: 'Outerwear' },
    { name: 'tees', display_name: 'Tees', emoji: '👕', color: '#c9bfb6', sort_order: 3, templateKey: 'Tees' },
    { name: 'bottoms', display_name: 'Bottoms', emoji: '👖', color: '#9aa3b2', sort_order: 4, templateKey: 'Bottoms' },
    { name: 'femme', display_name: 'Feminine', emoji: '👗', color: '#c2b2bb', sort_order: 5, templateKey: 'Tees' },
    { name: 'hats', display_name: 'Hats', emoji: '🧢', color: '#b8b09a', sort_order: 6, templateKey: 'Hats' },
    { name: 'mystery boxes', display_name: 'Mystery Boxes', emoji: '📦', color: '#7f8489', sort_order: 7, templateKey: 'Accessories' },
  ];
